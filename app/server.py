...
# os.environ['COHERE_API_KEY'] = "s40hftA1gSofIz9vQeO1wvydgsCR9GYhpdbggTBY"
...
#     """
#     The internet. Use web_search for questions that are related to anything else than user's symptom , antecendants ,other medical history,Uploaded images and uploaded pdfs and uploaded documents .
#     """
#     query: str = Field(description="The query to use when searching the internet.")

# class vectorstore(BaseModel):
#     """
#     A vectorstore containing documents related to user's symptom , antecendants ,other medical history,Uploaded images and uploaded pdfs and uploaded documents . Use the vectorstore for questions on these topics.
#     """
...
# except:
#     response =  retrieval_grader.invoke({"question": question, "document": ""})
...
# from langchain_community.llms import Ollama
# llm = ChatOllama(model="dhruvsingh959/ddx-llama")
